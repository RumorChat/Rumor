...
public class ClientAccepter {
            ...
            public void run() {
                while(true) {
                    try {
                        ...
                        ServerCore.getLogger().info("A " + Defaults.APP_NAME + " client has successfully connected!");
    ...
    public boolean stop() {
        ...
        try {
            ...
            ServerCore.getLogger().debug("Suppressed an exception which occurred while stopping the client acceptance thread!");
            ServerCore.getLogger().debug("ERROR: " + e.getMessage());
        }
